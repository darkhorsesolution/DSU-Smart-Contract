...
contract DeployTestHookFinal is Script {
    // BSC Pool Manager
    ...
    // Correct CREATE2Factory address
    address constant UNISWAP_CREATE2_FACTORY = 0x4e59b44847b379578588920cA78FbF26c0B4956C;
    ...
    function run() external {
        ...
        console2.log("CREATE2Factory:", UNISWAP_CREATE2_FACTORY);
        ...
        ICREATE2Factory factory = ICREATE2Factory(UNISWAP_CREATE2_FACTORY);
        address deployedHook = factory.deploy(0, salt, creationCode);
