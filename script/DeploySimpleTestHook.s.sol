...
contract DeploySimpleTestHook is Script {
    ...
    function run() external {
        ...
        console2.log("CREATE2Factory:", HOOK_CREATE2_FACTORY);
        ...
        bytes memory creationCode = abi.encodePacked(
            type(SimpleTestHook).creationCode,
        ...
        ICREATE2Factory factory = ICREATE2Factory(HOOK_CREATE2_FACTORY);
